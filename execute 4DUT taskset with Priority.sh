...
# grep "iops        : min=" logs/DUT1_RUN0_Log.txt logs/DUT2_RUN0_Log.txt logs/DUT3_RUN0_Log.txt logs/DUT4_RUN0_Log.txt | awk '{print $6}' > Iteration0_iops.txt
# grep "iops        : min=" logs/DUT1_RUN1_Log.txt logs/DUT2_RUN1_Log.txt logs/DUT3_RUN1_Log.txt logs/DUT4_RUN1_Log.txt | awk '{print $6}' > Iteration1_iops.txt
# grep "iops        : min=" logs/DUT1_RUN2_Log.txt logs/DUT2_RUN2_Log.txt logs/DUT3_RUN2_Log.txt logs/DUT4_RUN2_Log.txt | awk '{print $6}' > Iteration2_iops.txt
# grep "iops        : min=" logs/DUT1_RUN3_Log.txt logs/DUT2_RUN3_Log.txt logs/DUT3_RUN3_Log.txt logs/DUT4_RUN3_Log.txt | awk '{print $6}' > Iteration3_iops.txt
# grep "iops        : min=" logs/DUT1_RUN4_Log.txt logs/DUT2_RUN4_Log.txt logs/DUT3_RUN4_Log.txt logs/DUT4_RUN4_Log.txt | awk '{print $6}' > Iteration4_iops.txt
