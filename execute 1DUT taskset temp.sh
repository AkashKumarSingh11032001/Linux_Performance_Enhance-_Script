...
do
    ...
    taskset -a -c 0-4 fio DUT1.txt --eta-newline=1 --eta=always > logs/${f1} & CURR_PID=$! ; echo $CURR_PID ; for i in {1..300}; do echo $(ps -o psr $CURR_PID) >> "Currpsr_$iteration_$CURR_PID.txt" ; sleep 1; done & sleep 300
